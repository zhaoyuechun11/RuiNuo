...
import { failureRate } from '../../models/server';
...
const QCCVFailureRate = () => {
  ...
  const search = () => {
    ...
    if (showSelectedDate === 3) {
      ...
      console.log(new Date(monthEnd[0], monthEnd[1], 0).getDate());
    ...
    getCvFailureRate(allParams);
  };
  const getCvFailureRate = (params: any) => {
    failureRate(params).then((res) => {
      if (res.code === 200) {
...
export default QCCVFailureRate;
