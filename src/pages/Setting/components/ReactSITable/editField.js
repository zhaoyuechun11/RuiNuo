...
const EditField = ({
  ...
  useImperativeHandle(editFieldRefHide, () => ({
    hide: () => {
    ...
    <Fragment>
      ...
      >
        <Form
          ...
          onFinish={onFinish}
          className={style.editeFileFormWrap}
        >
          <Row span={24}>
            <Col span={24}>
          ...
          {fieldInfo && fieldInfo.data_type === 3 ? (
            <Row>
              ...
              <Col span={24}>
                <Form.List name="data_json1" className={style.formListWrap}>
                  {(fields, { add, remove }) => (
                    <>
                      {fields.map((field, index) => (
                        <Form.Item
