...
import style from './addField.less';
const { confirm } = Modal;
const AddField = ({
  addFieldRef,
  addFieldRefHide,
  ...
  useImperativeHandle(addFieldRefHide, () => ({
    hide: () => {
    ...
    <Fragment>
      ...
      >
        <Form
          ...
          onFinish={onFinish}
          className={style.addFileFormWrap}
        >
          ...
          {filedChoose ? (
            <Row>
              <Col span={24} className={style.listWrap}>
          ...
          <Row span={24} className={style.checkbox_wrap}>
            <Col span={11}>
              <Form.Item
                name="is_display"
