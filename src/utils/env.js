...
console.log(process.env.REACT_APP_ENV, 'REACT_APP_ENV_envjs');
console.log(process.env.REACT_APP_ENV, 'NODE_ENVjs');
const env = {
  development: {
    // apiurl_web: 'https://da.hire66.com', //线上 https://devbdh5.sogukj.com
    // apiurl_web: 'http://192.168.31.20:8080', //金绍彬本地
    apiurl_one: 'https://da.hire66.com', //线上 https://devbdh5.sogukj.com
  ...
  production: {
    ...
    apiurl_one: 'https://a.hire66.com', //线上 https://devbdh5.sogukj.com
