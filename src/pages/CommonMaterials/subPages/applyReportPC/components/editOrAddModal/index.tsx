...
import { Form, Input, message, Select, Row, Col, Checkbox } from 'antd';
      ...
      <Form form={form} {...layout} layout={'vertical'} style={{ padding: '20px' }}>
        <Row gutter={12}>
          ...
          <Col span={6}>
            ...
            >
              <Input maxLength={10} placeholder="请输入项目编码" />
            </Form.Item>
          </Col>
          <Col span={12}>
            <Form.Item
        ...
        <Row gutter={12}>
          <Col span={12}>
            <Form.Item
              label="缩写代号"
              name="shortName"
              rules={[{ required: true, message: '请输入缩写代号' }]}
            >
        ...
        <Row gutter={12}>
          <Col span={12}>
            <Form.Item label="其他编码1" name="extCode1">
              <Input maxLength={10} placeholder="请输入其他编码1" />
            </Form.Item>
          </Col>
          <Col span={12}>
            <Form.Item label="其他编码2" name="extCode2">
              <Input maxLength={10} placeholder="请输入其他编码2" />
            </Form.Item>
          </Col>
        </Row>
        <Row gutter={12}>
